...
public class PlayerHistory extends TableImpl<PlayerHistoryRecord> {
	...
	public final TableField<PlayerHistoryRecord, Integer> ID =
	...
	public final TableField<PlayerHistoryRecord, Integer> PLAYER_ID =
	...
	public final TableField<PlayerHistoryRecord, Integer> HISTORY =
			createField(
					DSL.name("history"),
	...
	public final TableField<PlayerHistoryRecord, Integer> BELONG_ID =
			createField(
					DSL.name("belong_id"),
	...
	public final TableField<PlayerHistoryRecord, String> NAME =
	...
	public final TableField<PlayerHistoryRecord, String> KANA =
			createField(
					DSL.name("kana"),
	...
	/** The column <code>athletics-tool.player_history.prefecture</code>. */
	public final TableField<PlayerHistoryRecord, PlayerHistoryPrefecture> PREFECTURE =
			createField(
					DSL.name("prefecture"),
					SQLDataType.VARCHAR(8)
							.nullable(false)
							.asEnumDataType(
									xyz.walk8243.athleticstool.repositoryapi.infrastructure.database.entity.enums
											.PlayerHistoryPrefecture.class),
					this,
					"");

	/** The column <code>athletics-tool.player_history.year</code>. */
	public final TableField<PlayerHistoryRecord, Integer> YEAR =
			createField(DSL.name("year"), SQLDataType.INTEGER.nullable(false), this, "");

	/** The column <code>athletics-tool.player_history.category</code>. */
	public final TableField<PlayerHistoryRecord, PlayerHistoryCategory> CATEGORY =
			createField(
					DSL.name("category"),
					SQLDataType.VARCHAR(11)
							...
							.asEnumDataType(
									xyz.walk8243.athleticstool.repositoryapi.infrastructure.database.entity.enums
											.PlayerHistoryCategory.class),
					this,
					"");

	/** The column <code>athletics-tool.player_history.created_at</code>. */
	public final TableField<PlayerHistoryRecord, LocalDateTime> CREATED_AT =
			createField(
					DSL.name("created_at"),
	...
	/** Create an aliased <code>athletics-tool.player_history</code> table reference */
	...
	/** Get the implicit join path to the <code>athletics-tool.player</code> table. */
	public Player player() {
		if (_player == null) _player = new Player(this, Keys.PLAYER_HISTORY_PLAYER_FK);

		return _player;
	}

	/** Get the implicit join path to the <code>athletics-tool.player_belong</code> table. */
	public PlayerBelong playerBelong() {
		if (_playerBelong == null) _playerBelong = new PlayerBelong(this, Keys.PLAYER_BELONG_FK);
	...
	public <U> SelectField<U> mapping(
			Function10<
							...
							? super String,
							? super String,
							? super PlayerHistoryPrefecture,
							? super Integer,
							? super PlayerHistoryCategory,
							? super LocalDateTime,
							? extends U>
					from) {
