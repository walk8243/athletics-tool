...
public class Player extends TableImpl<PlayerRecord> {
	...
	public final TableField<PlayerRecord, Integer> ID =
	...
	public final TableField<PlayerRecord, LocalDateTime> CREATED_AT =
			createField(
					DSL.name("created_at"),
	...
	public final TableField<PlayerRecord, LocalDateTime> UPDATED_AT =
			createField(
					DSL.name("updated_at"),
					SQLDataType.LOCALDATETIME(0)
							.defaultValue(DSL.field("current_timestamp()", SQLDataType.LOCALDATETIME)),
	...
	public <U> SelectField<U> mapping(
			Function3<? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
