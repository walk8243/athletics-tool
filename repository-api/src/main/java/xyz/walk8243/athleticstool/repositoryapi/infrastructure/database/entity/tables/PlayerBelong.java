...
public class PlayerBelong extends TableImpl<PlayerBelongRecord> {
     ...
     */
    public final TableField<PlayerBelongRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>athletics-tool.player_belong.name</code>.
     */
    public final TableField<PlayerBelongRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>athletics-tool.player_belong.delete_flag</code>.
     */
    public final TableField<PlayerBelongRecord, Byte> DELETE_FLAG = createField(DSL.name("delete_flag"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.field("0", SQLDataType.TINYINT)), this, "");

    /**
     * The column <code>athletics-tool.player_belong.created_at</code>.
     */
    public final TableField<PlayerBelongRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field("current_timestamp()", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>athletics-tool.player_belong.updated_at</code>.
     */
    public final TableField<PlayerBelongRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field("current_timestamp()", SQLDataType.LOCALDATETIME)), this, "");
    ...
    /**
     * Create an aliased <code>athletics-tool.player_belong</code> table
     * reference
     */
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Integer, ? super String, ? super Byte, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Integer, ? super String, ? super Byte, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
